...
.flash__container.success {
    color: white;
    background-color: var(--flashswal-background-success);
}
.flash__container.warning {
    color: black;
    background-color: var(--flashswal-background-warning);
}
.flash__container.error {
    color: white;
    background-color: var(--flashswal-background-error);
}
...
:root {
    --flashswal-background-success: #00ee00;
    --flashswal-background-warning: #eeee00;
    --flashswal-background-error: #ee0000;
}
